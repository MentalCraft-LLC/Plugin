...
| [`Browser/`](./Browser) | Browser Automation & CDP Native Bridge | Inactive-tab driving, screencast/video recording, semantic snapshots, visual annotations, Web Vitals profiling, CDP actions |
...
# Run business & SEO intelligence tests
bun test Business/
```
