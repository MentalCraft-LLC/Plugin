...
export const COMPONENT_CATALOG: ComponentSpec[] = [
  ...
  },
  {
    ...
    estimatedSizeKb: 6.8,
    variants: ["standard", "compact", "split", "embedded"],
    props: [
      { name: "variant", type: "'standard' | 'compact' | 'split' | 'embedded'", required: false, default: "'standard'", description: "Screener layout variant" },
  ...
  },
  {
    ...
    estimatedSizeKb: 7.2,
    variants: ["stepped", "continuous", "cards", "minimal"],
    props: [
      { name: "variant", type: "'stepped' | 'continuous' | 'cards' | 'minimal'", required: false, default: "'stepped'", description: "Progression mode" },
  ...
  },
  {
    ...
    estimatedSizeKb: 3.1,
    variants: ["standard", "split", "centered", "glow", "magazine"],
    props: [
      { name: "variant", type: "'standard' | 'split' | 'centered' | 'glow' | 'magazine'", required: false, default: "'standard'", description: "Hero visual presentation" },
  ...
  },
  {
    ...
    estimatedSizeKb: 4.5,
    variants: ["tier_cards", "matrix", "compact", "comparison"],
    props: [
      { name: "variant", type: "'tier_cards' | 'matrix' | 'compact' | 'comparison'", required: false, default: "'tier_cards'", description: "Pricing display mode" },
  ...
  },
  {
    ...
    estimatedSizeKb: 8.4,
    variants: ["standard", "compact", "matrix", "glass"],
    props: [
      { name: "variant", type: "'standard' | 'compact' | 'matrix' | 'glass'", required: false, default: "'standard'", description: "Board theme" },
  ...
  },
  {
    ...
    variants: ["standard", "subdivided", "minimal", "gridless"],
    props: [
      { name: "variant", type: "'standard' | 'subdivided' | 'minimal' | 'gridless'", required: false, default: "'standard'", description: "Tick and label rendering style" },
  ...
  },
  {
    ...
    estimatedSizeKb: 0.8,
    parentComposite: "chart",
    variants: ["dashed", "solid", "dotted", "crosshair"],
    props: [
      { name: "variant", type: "'dashed' | 'solid' | 'dotted' | 'crosshair'", required: false, default: "'dashed'", description: "Grid line stroke style" },
  ...
  },
  {
    ...
    estimatedSizeKb: 0.9,
    parentComposite: "chart",
    variants: ["target", "threshold", "breakeven", "baseline", "alert"],
    props: [
      { name: "variant", type: "'target' | 'threshold' | 'breakeven' | 'baseline' | 'alert'", required: false, default: "'target'", description: "Threshold semantics" },
  ...
  },
  {
    ...
    estimatedSizeKb: 1.6,
    parentComposite: "chart",
    variants: ["monotone", "linear", "step", "dashed", "glow"],
    props: [
      { name: "curve", type: "'linear' | 'monotone' | 'step'", required: false, default: "'monotone'", description: "Spline interpolation" },
      { name: "variant", type: "'monotone' | 'linear' | 'step' | 'dashed' | 'glow'", required: false, default: "'monotone'", description: "Line presentation style" },
  ...
  },
  {
    ...
    estimatedSizeKb: 1.2,
    parentComposite: "chart",
    variants: ["gradient", "solid", "pattern", "subtle"],
    props: [
      { name: "variant", type: "'gradient' | 'solid' | 'pattern' | 'subtle'", required: false, default: "'gradient'", description: "Area fill mode" },
  ...
  },
  {
    ...
    estimatedSizeKb: 1.5,
    parentComposite: "chart",
    variants: ["standard", "rounded", "stacked", "waterfall", "horizontal"],
    props: [
      { name: "variant", type: "'standard' | 'rounded' | 'stacked' | 'waterfall' | 'horizontal'", required: false, default: "'rounded'", description: "Bar column style" },
  ...
  },
  {
    ...
    estimatedSizeKb: 0.9,
    parentComposite: "chart",
    variants: ["circle", "diamond", "square", "bubble", "ring"],
    props: [
      { name: "variant", type: "'circle' | 'diamond' | 'square' | 'bubble' | 'ring'", required: false, default: "'circle'", description: "Marker shape" },
  ...
  },
  {
    ...
    estimatedSizeKb: 1.8,
    parentComposite: "chart",
    variants: ["pie", "donut", "semicircle", "gauge"],
    props: [
      { name: "variant", type: "'pie' | 'donut' | 'semicircle' | 'gauge'", required: false, default: "'donut'", description: "Polar geometry mode" },
  ...
  },
  {
    ...
    estimatedSizeKb: 1.1,
    parentComposite: "chart",
    variants: ["line", "area", "bar", "stepped"],
    props: [
      { name: "variant", type: "'line' | 'area' | 'bar' | 'stepped'", required: false, default: "'line'", description: "Micro-trend style" },
  ...
  },
  {
    ...
    estimatedSizeKb: 0.7,
    parentComposite: "chart",
    variants: ["top", "bottom", "right", "floating", "minimal"],
    props: [
      { name: "variant", type: "'top' | 'bottom' | 'right' | 'floating' | 'minimal'", required: false, default: "'top'", description: "Legend layout style" },
  ...
  },
  {
    ...
    estimatedSizeKb: 1.3,
    parentComposite: "chart",
    variants: ["floating", "snap", "fixed", "badge"],
    props: [
      { name: "variant", type: "'floating' | 'snap' | 'fixed' | 'badge'", required: false, default: "'floating'", description: "Popover attachment style" },
  ...
  },
  {
    ...
    variants: ["sticky", "static", "floating", "underlined"],
    props: [
      { name: "variant", type: "'sticky' | 'static' | 'floating' | 'underlined'", required: false, default: "'sticky'", description: "Head positioning and boundary style" },
    ],
    slots: ["children"],
    a11yRole: "rowgroup",
  ...
  },
  {
    ...
    estimatedSizeKb: 1.4,
    parentComposite: "table",
    variants: ["sortable", "resizable", "center", "right", "left"],
    props: [
      { name: "variant", type: "'sortable' | 'resizable' | 'center' | 'right' | 'left'", required: false, default: "'left'", description: "Header interaction style" },
    ...
    example: `<Table.Header sortable align="left">Customer</Table.Header>`,
  },
  {
    id: "body",
    name: "Body",
    ...
    estimatedSizeKb: 0.7,
    parentComposite: "table",
    variants: ["standard", "zebra", "striped", "empty_placeholder"],
    props: [
      { name: "variant", type: "'standard' | 'zebra' | 'striped' | 'empty_placeholder'", required: false, default: "'standard'", description: "Body rows styling" },
    ],
    slots: ["children"],
    a11yRole: "rowgroup",
  ...
  },
  {
    ...
    estimatedSizeKb: 0.9,
    parentComposite: "table",
    variants: ["standard", "selectable", "expandable", "highlighted", "disabled"],
    props: [
      { name: "variant", type: "'standard' | 'selectable' | 'expandable' | 'highlighted' | 'disabled'", required: false, default: "'standard'", description: "Row state style" },
  ...
  },
  {
    ...
    estimatedSizeKb: 0.8,
    parentComposite: "table",
    variants: ["text", "numeric_mono", "badge", "sparkline", "avatar", "action"],
    props: [
      { name: "variant", type: "'text' | 'numeric_mono' | 'badge' | 'sparkline' | 'avatar' | 'action'", required: false, default: "'text'", description: "Cell data formatter" },
  ...
  },
  {
    ...
    estimatedSizeKb: 0.5,
    parentComposite: "table",
    variants: ["summary", "pagination", "totals", "sticky"],
    props: [
      { name: "variant", type: "'summary' | 'pagination' | 'totals' | 'sticky'", required: false, default: "'totals'", description: "Footer accumulator layout" },
    ],
    slots: ["children"],
    a11yRole: "rowgroup",
  ...
  },
  {
    ...
    estimatedSizeKb: 1.3,
    variants: ["circle", "rounded", "square", "ring", "online_indicator"],
    props: [
      { name: "variant", type: "'circle' | 'rounded' | 'square' | 'ring' | 'online_indicator'", required: false, default: "'circle'", description: "Avatar frame geometry" },
  ...
  // --- KANBAN SUITE ---
  {
    ...
    layer: "component",
    category: "workflow",
    description: "Discrete vertical column container for draggable card clusters with badge header.",
    importPath: "infra-ui-svelte",
    subpath: "infra-ui-svelte/composite/workflow/kanban/column",
    estimatedSizeKb: 1.6,
    parentComposite: "kanban",
    variants: ["standard", "collapsed", "accent", "ghost"],
    props: [
      { name: "variant", type: "'standard' | 'collapsed' | 'accent' | 'ghost'", required: false, default: "'standard'", description: "Column styling" },
    ...
    a11yRole: "region",
    example: `<Kanban.Column id="in_progress" title="In Progress" count={4}>...</Kanban.Column>`,
  },
  // --- TERMINAL SUITE ---
  {
    id: "terminal",
    ...
    layer: "composite",
    category: "workflow",
    description: "Interactive developer CLI console with syntax highlighting, streaming stdout, and ANSI colors.",
    importPath: "infra-ui-svelte",
    subpath: "infra-ui-svelte/composite/workflow/terminal",
    estimatedSizeKb: 6.2,
    primitives: ["prompt", "output", "cursor", "header"],
    variants: ["classic", "glass", "minimal", "matrix", "dracula", "retro"],
    props: [
      { name: "title", type: "string", required: false, default: "'bash'", description: "Terminal titlebar text" },
      { name: "variant", type: "'classic' | 'glass' | 'minimal' | 'matrix' | 'dracula' | 'retro'", required: false, default: "'glass'", description: "Visual window style" },
  ...
  },
  {
    ...
    layer: "component",
    category: "workflow",
    description: "Command prompt input line with cwd badge, chevron prompt sign, and history navigation.",
    importPath: "infra-ui-svelte",
    subpath: "infra-ui-svelte/composite/workflow/terminal/prompt",
    estimatedSizeKb: 1.2,
    parentComposite: "terminal",
    variants: ["bash", "zsh", "powershell", "python", "arrow", "badge"],
    props: [
      { name: "variant", type: "'bash' | 'zsh' | 'powershell' | 'python' | 'arrow' | 'badge'", required: false, default: "'bash'", description: "Prompt glyph style" },
    ...
    example: `<Terminal.Prompt cwd="~/Holar/Plugin" command="bun cli.ts docs" />`,
  },
  {
    id: "output",
    name: "Output",
    layer: "component",
    category: "workflow",
    description: "Monospace stdout stream viewer with ANSI color parsing and copy-to-clipboard trigger.",
    importPath: "infra-ui-svelte",
    subpath: "infra-ui-svelte/composite/workflow/terminal/output",
    estimatedSizeKb: 1.5,
    parentComposite: "terminal",
    variants: ["stdout", "stderr", "command", "success", "json", "diff"],
    props: [
      { name: "variant", type: "'stdout' | 'stderr' | 'command' | 'success' | 'json' | 'diff'", required: false, default: "'stdout'", description: "Stream output tint" },
    ...
    example: `<Terminal.Output text="✓ 255 pass across 26 files (0 errors)" status="success" />`,
  },
  // --- TIMELINE SUITE ---
  {
    id: "timeline",
    ...
    layer: "composite",
    category: "workflow",
    description: "Vertical or horizontal event sequence tracker with progress connectors and timestamp markers.",
    importPath: "infra-ui-svelte",
    subpath: "infra-ui-svelte/composite/workflow/timeline",
    estimatedSizeKb: 3.6,
    primitives: ["item", "point", "track", "content"],
    variants: ["vertical", "horizontal", "compact", "alternating", "stepper"],
    props: [
      { name: "orientation", type: "'vertical' | 'horizontal'", required: false, default: "'vertical'", description: "Layout axis" },
      { name: "variant", type: "'vertical' | 'horizontal' | 'compact' | 'alternating' | 'stepper'", required: false, default: "'vertical'", description: "Layout style" },
    ],
  ...
  },
  {
    ...
    layer: "component",
    category: "workflow",
    description: "Single milestone event node in a sequence with completion status.",
    importPath: "infra-ui-svelte",
    subpath: "infra-ui-svelte/composite/workflow/timeline/item",
    estimatedSizeKb: 1.1,
    ...
    slots: ["children"],
    example: `<Timeline.Item status="completed">...</Timeline.Item>`,
  },
  // --- COMMAND SUITE ---
  {
    id: "command",
    ...
    layer: "composite",
    category: "workflow",
    description: "Keyboard-first ⌘K spotlight command search modal with fuzzy search and arrow navigation.",
    importPath: "infra-ui-svelte",
    subpath: "infra-ui-svelte/composite/workflow/command",
    estimatedSizeKb: 5.4,
    primitives: ["input", "list", "item", "group", "shortcut"],
    variants: ["spotlight", "compact", "docked", "dialog", "inline"],
    props: [
      { name: "variant", type: "'spotlight' | 'compact' | 'docked' | 'dialog' | 'inline'", required: false, default: "'spotlight'", description: "Command palette layout" },
  ...
  // --- ACCORDION SUITE ---
  {
    ...
    layer: "composite",
    category: "panel",
    description: "Vertically stacked interactive collapsible content panels with animated height transitions.",
    importPath: "infra-ui-svelte",
    subpath: "infra-ui-svelte/panel/accordion",
    estimatedSizeKb: 2.8,
    primitives: ["item", "trigger", "content"],
    variants: ["bordered", "separated", "ghost", "compact", "glass"],
    props: [
      { name: "type", type: "'single' | 'multiple'", required: false, default: "'single'", description: "Allow multiple panels open" },
      { name: "variant", type: "'bordered' | 'separated' | 'ghost' | 'compact' | 'glass'", required: false, default: "'bordered'", description: "Visual border style" },
    ],
  ...
  // --- TABS SUITE ---
  {
    ...
    layer: "composite",
    category: "navigation",
    description: "Accessible navigational tab bar coordinating mutually exclusive content views with keyboard navigation.",
    importPath: "infra-ui-svelte",
    subpath: "infra-ui-svelte/composite/route/tabs",
    estimatedSizeKb: 2.4,
    ...
    example: `<Tabs bind:value={activeTab}>\n  <Tabs.List>\n    <Tabs.Trigger value="overview">Overview</Tabs.Trigger>\n    <Tabs.Trigger value="analytics">Analytics</Tabs.Trigger>\n  </Tabs.List>\n  <Tabs.Content value="overview">Overview content...</Tabs.Content>\n</Tabs>`,
  },
  // --- METRIC DISPLAY ATOM ---
  {
    id: "metric",
    ...
    layer: "component",
    category: "display",
    description: "High-impact KPI metric visual with tabular font features, delta trend badges, and trend sparklines.",
    importPath: "infra-ui-svelte",
    subpath: "infra-ui-svelte/component/display/metric",
    estimatedSizeKb: 1.7,
    variants: ["standard", "compact", "hero", "delta_badge", "sparkline_card"],
    props: [
      { name: "variant", type: "'standard' | 'compact' | 'hero' | 'delta_badge' | 'sparkline_card'", required: false, default: "'standard'", description: "Metric card layout variant" },
    ...
    a11yRole: "status",
    example: `<Metric value="10,000" prefix="$" suffix="/mo" label="Monthly Recurring Revenue" delta={24.5} />`,
  },
  // --- TOAST SUITE ---
  {
    id: "toast",
    ...
    layer: "composite",
    category: "feedback",
    description: "Floating non-disruptive feedback notification with auto-dismiss timers and action buttons.",
    importPath: "infra-ui-svelte",
    subpath: "infra-ui-svelte/overlay/toast",
    estimatedSizeKb: 3.2,
    primitives: ["provider", "item", "action", "close"],
    variants: ["success", "warning", "destructive", "info", "ai", "promise"],
    props: [
      { name: "variant", type: "'success' | 'warning' | 'destructive' | 'info' | 'ai' | 'promise'", required: false, default: "'info'", description: "Toast tone variant" },
  ...
  // --- DESIGN ENGINEERING PRIMITIVES (interfaces.dev class) ---
  {
    id: "blueprint",
    name: "Blueprint",
    layer: "component",
    ...
    importPath: "infra-ui-svelte",
    subpath: "infra-ui-svelte/decoration/blueprint",
    estimatedSizeKb: 1.4,
    variants: ["blue", "cyan", "pink", "amber", "monochrome", "grid"],
    props: [
      { name: "variant", type: "'blue' | 'cyan' | 'pink' | 'amber' | 'monochrome' | 'grid'", required: false, default: "'blue'", description: "Anchor theme color and style" },
      ...
      { name: "color", type: "'blue' | 'cyan' | 'pink' | 'amber'", required: false, default: "'blue'", description: "Anchor theme color" },
    ],
    slots: ["children"],
    a11yRole: "presentation",
    example: `<Blueprint label="294 × 58" xHeight={true}>\n  <h1 class="text-6xl font-medium">Interfaces</h1>\n</Blueprint>`,
  },
  {
    id: "ruler",
    name: "Ruler",
    layer: "component",
    category: "decoration",
    description: "Visual spacing and margin gap inspection overlay with exact pixel readout and translucent fill.",
    importPath: "infra-ui-svelte",
    subpath: "infra-ui-svelte/decoration/ruler",
    estimatedSizeKb: 0.9,
    variants: ["pink", "cyan", "amber", "blue", "horizontal", "vertical"],
    props: [
      { name: "variant", type: "'pink' | 'cyan' | 'amber' | 'blue' | 'horizontal' | 'vertical'", required: false, default: "'pink'", description: "Ruler theme" },
      { name: "size", type: "number | string", required: true, description: "Spacing dimension in px" },
      { name: "orientation", type: "'horizontal' | 'vertical'", required: false, default: "'horizontal'", description: "Ruler axis" },
      { name: "color", type: "'pink' | 'cyan' | 'amber' | 'blue'", required: false, default: "'pink'", description: "Highlight color" },
    ],
    a11yRole: "presentation",
    example: `<Ruler size={32} color="pink" />`,
  },
  {
    id: "swatch",
    name: "Swatch",
    layer: "component",
    category: "decoration",
    description: "Interactive color token chip with live OKLCH preview dot and one-click clipboard copy.",
    importPath: "infra-ui-svelte",
    subpath: "infra-ui-svelte/decoration/swatch",
    estimatedSizeKb: 1.1,
    variants: ["chip", "pill", "dot", "bubble", "palette"],
    props: [
      { name: "variant", type: "'chip' | 'pill' | 'dot' | 'bubble' | 'palette'", required: false, default: "'chip'", description: "Swatch chip geometry" },
    ...
    a11yRole: "button",
    example: `<Swatch color="oklch(0.991 0 0)" label="oklch(0.991 0 0)" />`,
  },
  {
    id: "slider",
    name: "Slider",
    layer: "component",
    category: "input",
    description: "Tactile high-precision slider with 45° diamond thumb variant, live numeric readout, and spring drag feedback.",
    importPath: "infra-ui-svelte",
    subpath: "infra-ui-svelte/component/input/slider",
    estimatedSizeKb: 1.6,
    variants: ["diamond", "round", "minimal", "stepped", "spring"],
    props: [
      ...
      { name: "variant", type: "'diamond' | 'round' | 'minimal' | 'stepped' | 'spring'", required: false, default: "'diamond'", description: "Thumb geometry" },
    ],
    a11yRole: "slider",
    example: `<Slider bind:value={width} min={220} max={300} label="Width" unit="px" variant="diamond" />`,
  },
  {
    id: "comparison",
    name: "Comparison",
    layer: "composite",
    category: "display",
    description: "Split-view design engineering sandbox comparing live CSS properties, animations, and typography side-by-side.",
    importPath: "infra-ui-svelte",
    subpath: "infra-ui-svelte/composite/display/comparison",
    estimatedSizeKb: 2.2,
    variants: ["split_horizontal", "split_vertical", "slider_curtain", "cards"],
    props: [
      { name: "variant", type: "'split_horizontal' | 'split_vertical' | 'slider_curtain' | 'cards'", required: false, default: "'split_horizontal'", description: "Comparison layout mode" },
