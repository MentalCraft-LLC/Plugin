...
export const COMPONENT_CATALOG: ComponentSpec[] = [
  ...
  // --- 10. DESIGN ENGINEERING & DECORATION FAMILY ---
  {
    ...
    layer: "component",
    category: "decoration",
    description: "Design engineering bounding box sharing decoration family color themes (blue, cyan, pink, amber, monochrome, grid).",
    importPath: "infra-ui-svelte",
    ...
    slots: ["children"],
    a11yRole: "presentation",
    example: `<Blueprint label="294 × 58" xHeight={true} variant="blue">\n  <h1 class="text-6xl font-medium">Interfaces</h1>\n</Blueprint>`,
  },
  {
    id: "ruler",
    name: "Ruler",
    layer: "component",
    category: "decoration",
    description: "Visual spacing gap inspection overlay sharing decoration family color themes.",
    importPath: "infra-ui-svelte",
    subpath: "infra-ui-svelte/decoration/ruler",
    estimatedSizeKb: 0.9,
    variants: ["blue", "cyan", "pink", "amber", "monochrome", "grid"],
    props: [
      { name: "variant", type: "'blue' | 'cyan' | 'pink' | 'amber' | 'monochrome' | 'grid'", required: false, default: "'pink'", description: "Ruler theme" },
    ...
    a11yRole: "presentation",
    example: `<Ruler size={32} variant="pink" />`,
  },
  {
    id: "spotlight",
    name: "Spotlight",
    layer: "component",
    category: "effect",
    description: "Interactive ambient cursor-tracking lighting effect sharing decoration family color themes.",
    importPath: "infra-ui-svelte",
    subpath: "infra-ui-svelte/effect/spotlight",
    estimatedSizeKb: 1.2,
    variants: ["blue", "cyan", "pink", "amber", "monochrome", "grid"],
    props: [
      { name: "variant", type: "'blue' | 'cyan' | 'pink' | 'amber' | 'monochrome' | 'grid'", required: false, default: "'blue'", description: "Spotlight theme profile" },
