...
export const COMPONENT_CATALOG: ComponentSpec[] = [
  ...
  },
  {
    ...
    layer: "component",
    category: "workflow",
    description: "Interactive draggable item card with priority indicator, assignee avatar, and tags.",
    importPath: "infra-ui-svelte",
    subpath: "infra-ui-svelte/composite/workflow/kanban/card",
    estimatedSizeKb: 1.9,
    parentComposite: "kanban",
    props: [
      { name: "id", type: "string", required: true, description: "Card identifier" },
      { name: "title", type: "string", required: true, description: "Card summary title" },
      { name: "priority", type: "'low' | 'medium' | 'high' | 'urgent'", required: false, default: "'medium'", description: "Priority level" },
    ],
    slots: ["children", "tags", "footer"],
    a11yRole: "article",
    example: `<Kanban.Card id="card_1" title="Optimize pSEO Matrix" priority="urgent" />`,
  },
  // --- TERMINAL SUITE ---
  {
    id: "terminal",
    ...
    estimatedSizeKb: 6.2,
    primitives: ["terminal_prompt", "terminal_output", "terminal_cursor", "terminal_header"],
  ...
  // --- TIMELINE SUITE ---
  {
    ...
    estimatedSizeKb: 3.6,
    primitives: ["timeline_item", "timeline_point", "timeline_connector", "timeline_content"],
  ...
  },
  {
    ...
    layer: "component",
    category: "workflow",
    description: "Single milestone event node in a timeline sequence with completion status.",
    importPath: "infra-ui-svelte",
  ...
  // --- COMMAND PALETTE SUITE ---
  {
    ...
    estimatedSizeKb: 5.4,
    primitives: ["command_input", "command_list", "command_item", "command_group", "command_shortcut"],
  ...
  // --- ACCORDION SUITE ---
  {
    ...
    estimatedSizeKb: 2.8,
    primitives: ["accordion_item", "accordion_trigger", "accordion_content"],
  ...
  // --- TABS SUITE ---
  {
    ...
    estimatedSizeKb: 2.4,
    primitives: ["tabs_list", "tabs_trigger", "tabs_content"],
  ...
  // --- TOAST SUITE ---
  {
    ...
    estimatedSizeKb: 3.2,
    primitives: ["toast_provider", "toast_item", "toast_action", "toast_close"],
