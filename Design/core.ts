...
export const COMPONENT_CATALOG: ComponentSpec[] = [
  ...
  // --- TERMINAL SUITE ---
  {
    ...
    variants: ["classic", "glass", "minimal", "matrix"],
    props: [
      { name: "title", type: "string", required: false, default: "'bash'", description: "Terminal titlebar text" },
      { name: "variant", type: "'classic' | 'glass' | 'minimal' | 'matrix'", required: false, default: "'glass'", description: "Visual window style" },
  ...
  // --- TIMELINE SUITE ---
  {
    ...
    variants: ["vertical", "horizontal", "compact", "alternating"],
    props: [
      { name: "orientation", type: "'vertical' | 'horizontal'", required: false, default: "'vertical'", description: "Layout axis" },
      { name: "variant", type: "'vertical' | 'horizontal' | 'compact' | 'alternating'", required: false, default: "'vertical'", description: "Layout style" },
    ],
  ...
  // --- COMMAND SUITE ---
  {
    ...
    variants: ["spotlight", "compact", "docked"],
    props: [
  ...
  // --- ACCORDION SUITE ---
  {
    ...
    variants: ["bordered", "separated", "ghost", "compact"],
    props: [
      { name: "type", type: "'single' | 'multiple'", required: false, default: "'single'", description: "Allow multiple panels open" },
      { name: "variant", type: "'bordered' | 'separated' | 'ghost' | 'compact'", required: false, default: "'bordered'", description: "Visual border style" },
    ],
  ...
  // --- TABS SUITE ---
  {
    ...
    variants: ["pill", "underline", "segment", "vertical"],
    props: [
      { name: "value", type: "string", required: true, description: "Active tab identifier" },
      { name: "variant", type: "'pill' | 'underline' | 'segment' | 'vertical'", required: false, default: "'underline'", description: "Indicator style" },
    ],
  ...
  // --- METRIC DISPLAY ATOM ---
  {
    ...
    estimatedSizeKb: 1.7,
    variants: ["standard", "compact", "hero", "delta_badge"],
    props: [
  ...
  // --- TOAST SUITE ---
  {
    ...
    variants: ["success", "warning", "destructive", "info", "ai"],
    props: [
  ...
  },
  {
    ...
    estimatedSizeKb: 1.6,
    variants: ["diamond", "round", "minimal"],
    props: [
      ...
      { name: "variant", type: "'diamond' | 'round' | 'minimal'", required: false, default: "'diamond'", description: "Thumb geometry" },
    ],
    a11yRole: "slider",
