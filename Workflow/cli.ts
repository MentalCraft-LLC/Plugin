...
╠════════════════════════════════════════════════════════════════════════════════╣
║ ACTIVE CAPABILITY SUBSYSTEMS (7 Modules / 171 Actions)                         ║
║  • Business  [${report.plugins.business?.status === "healthy" ? "🟢 HEALTHY" : "🔴 DEGRADED"}] (40 actions) | 8-Stage Venture Lifecycle & Dual $10k MRR║
