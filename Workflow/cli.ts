...
export function generateMarkdownCatalog(): string {
  const lines: string[] = [
    ...
    "| `Business` | 31 | `holar.business.v1` | 8-Stage Venture Lifecycle, Dual $10k MRR Engines, Telemetry Tracker, Leak Auditor, Cross-Sell Funnel |",
...
╠════════════════════════════════════════════════════════════════════════════════╣
║ ACTIVE CAPABILITY SUBSYSTEMS (7 Modules / 162 Actions)                         ║
║  • Business  [${report.plugins.business?.status === "healthy" ? "🟢 HEALTHY" : "🔴 DEGRADED"}] (31 actions) | 8-Stage Venture Lifecycle & Dual $10k MRR║
