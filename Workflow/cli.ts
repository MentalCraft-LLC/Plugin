...
╠════════════════════════════════════════════════════════════════════════════════╣
║ ACTIVE CAPABILITY SUBSYSTEMS (7 Modules / 158 Actions)                         ║
║  • Business  [${report.plugins.business?.status === "healthy" ? "🟢 HEALTHY" : "🔴 DEGRADED"}] (27 actions) | 8-Stage Venture Lifecycle & $10k MRR  ║
