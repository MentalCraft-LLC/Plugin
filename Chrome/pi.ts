...
function registerBrowserTool(
  ...
  pi.registerTool({
    ...
    parameters: Type.Object({
      ...
      from_x: Type.Optional(Type.Integer({ minimum: 1, maximum: 100000 })),
      from_y: Type.Optional(Type.Integer({ minimum: 1, maximum: 100000 })),
      to_x: Type.Optional(Type.Integer({ minimum: 1, maximum: 100000 })),
      to_y: Type.Optional(Type.Integer({ minimum: 1, maximum: 100000 })),
      source_selector: Type.Optional(Type.String({ minLength: 1, maxLength: 500 })),
      target_selector: Type.Optional(Type.String({ minLength: 1, maxLength: 500 })),
      file_name: Type.Optional(Type.String({ minLength: 1, maxLength: 255 })),
      file_content: Type.Optional(Type.String({ maxLength: 500000 })),
      file_type: Type.Optional(Type.String({ maxLength: 100 })),
      base64: Type.Optional(Type.String({ maxLength: 5000000 })),
      ...
      storage_type: Type.Optional(StringEnum(["local", "session", "all"] as const)),
